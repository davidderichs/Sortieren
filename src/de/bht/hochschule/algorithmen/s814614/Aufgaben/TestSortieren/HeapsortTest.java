...
import de.bht.hochschule.algorithmen.s814614.Aufgaben.Sortieren.Heapsort;
...
public class HeapsortTest{
    ...
    public void testHeapsort() throws Exception {
        ...
        try {
            fos = new FileOutputStream("./src/de//bht//hochschule//algorithmen//s814614//Aufgaben//TestSortieren///resultsHeapsort.txt");
        }
        catch ( Exception e) {
        ...
        fos.write(new String ("Test und Laufzeiten fuer Heapsort:\n\n").getBytes());
        System.out.println("Test und Laufzeiten fuer Heapsort:\n");
